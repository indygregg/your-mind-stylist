...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    ...
    <EditModeProvider>
      ...
      {/* Header */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 safe-area-top relative ${isScrolled ? 'bg-[#F9F5EF]/95 backdrop-blur-md shadow-sm' : (currentPageName === 'LearnHypnosis' ? 'bg-[#1E3A32]' : 'bg-transparent')}`}
      >

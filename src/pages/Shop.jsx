...
export default function Shop() {
  ...
  return (
    <div className="bg-[#F9F5EF] min-h-screen">
      ...
      {/* Filters */}
      <section className="pb-6 sticky top-[72px] z-30 bg-[#F9F5EF]/95 backdrop-blur-sm border-b border-[#E4D9C4]">
        <div className="max-w-6xl mx-auto px-6 flex items-center gap-2 overflow-x-auto py-3">
          <Filter size={15} className="text-[#2B2725]/40 flex-shrink-0" />
          {FILTERS.map((f) => (
            <button
              key={f.value}
              ...
              className={`px-4 py-2 text-sm rounded-full whitespace-nowrap transition-all border ${
                activeFilter === f.value
                  ? "bg-[#1E3A32] text-[#F9F5EF] border-[#1E3A32]"
                  : "bg-white text-[#2B2725]/70 border-[#E4D9C4] hover:border-[#D8B46B]"
              }`}
            >
              {f.label}
            </button>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-6">
          {isLoading ? (
            ...
            <div className="text-center py-24 text-[#2B2725]/50">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      <h3 className="font-serif text-xl text-[#1E3A32] mb-2 leading-snug">
                        {product.name}
                      </h3>
                      {product.tagline && (
                        <p className="text-[#D8B46B] text-sm mb-2">{product.tagline}</p>
                      )}
                      <p className="text-[#2B2725]/60 text-sm mb-4 flex-1 line-clamp-2">
